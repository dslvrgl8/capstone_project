...
class Gear(models.Model):
    ...
    character = models.ForeignKey('main_app.Character', on_delete=models.CASCADE, related_name="gears")
...
class Character(models.Model):
    ...
    gear = models.ForeignKey(Gear, on_delete=models.CASCADE, related_name="characters", default=0)
